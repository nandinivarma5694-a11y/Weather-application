...
export default function WeatherApp() {
  ...
  return (
    ...
    >
      {/* Sidebar */}
      <div style={{ width: "200px", background: "rgba(40,44,52,0.8)", color: "white", padding: "20px" }}>
        ...
        {cities.map((c) => (
          <div
            ...
            style={{
              ...
              padding: "8px",
              borderRadius: "5px",
              background: city === c ? "#61dafb" : "transparent",
              color: city === c ? "black" : "white",
            }}
          >
            {c}
          </div>
      ...
      <div style={{ flex: 1, padding: "30px", textAlign: "center" }}>
        <a href="/Logout">
          <button style={{ background: "red", float: "right", color: "white" }} className="logout1">
            Logout
          </button>
        </a>
        ...
        <button
          ...
          style={{ marginLeft: "10px", padding: "10px 20px", fontSize: "16px", background: "#4caf50", color: "white" }}
        >
          Detect My Location
        </button>

        {weather && weather.location && (
          <div style={{ marginTop: "20px", background: "rgba(133, 133, 133, 0.94)", padding: "20px", borderRadius: "15px" }}>
              ...
              {weather.forecast.forecastday.map((day) => (
                <div
                  ...
                  style={{
                    ...
                    borderRadius: "10px",
                    cursor: "pointer",
                    background: selectedDay?.date === day.date ? "#61dafb" : "rgba(255,255,255,0.7)",
                  }}
                >
                  <p><b>{day.date}</b></p>
            ...
            {selectedDay && (
              <div style={{ marginTop: "30px", padding: "20px", border: "1px solid #ccc", borderRadius: "10px", background: "rgba(240,240,240,0.9)" }}>
